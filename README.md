...
長野県立上田高校を経て、慶應義塾大学・同大学院を卒業。2017年に日本マイクロソフト株式会社にフィールドエンジニアとして入社し、日系大手企業のアジャイル開発やクラウド導入を支援。その後、アプリケーションデベロップメントマネジャーとしてDevOpsやクラウドネイティブの導入支援をリードした。

現在はソリューションスペシャリストとして、アプリモダナイゼーションの価値をクラウドネイティブ・DevOpsの視点で多くの企業へ広げている。近年は生成AIプロジェクトを多数リードしており、DevOps導入やクラウドのAIサービスを活用したアプリケーション開発を得意とする。
